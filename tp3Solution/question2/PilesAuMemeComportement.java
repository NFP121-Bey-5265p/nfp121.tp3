...
public class PilesAuMemeComportement extends junit.framework.TestCase {
    ...
    public void test_meme_comportement() throws Exception { 
        ...
        assertEquals("p1.capacite() == p4.capacite() ??",p1.capacite(), p4.capacite());
        ...
        assertEquals("p3.estPleine()!=  p4.estPleine() ??? ",p3.estPleine(), p4.estPleine());
